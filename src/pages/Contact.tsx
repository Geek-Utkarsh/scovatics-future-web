...
const Contact = () => {
  ...
  return (
    <>
      <Hero
        title="Get In Touch"
        subtitle="Ready to transform your data into actionable insights? Let's start the conversation."
        showImage={false}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" size="lg" className="w-full glow-teal">
                Send Message
              </Button>
            </form>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">contact@scovatics.com</p>
                  <p className="text-muted-foreground">sales@scovatics.com</p>
                </div>
              </div>
